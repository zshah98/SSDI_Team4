     ...
     <form method="post" ng-submit="showBook()">
      ...
      <table border = "1px" align="center">
      	<tr>
      		...
      		<th><input type="button" name="room_link5" class="btn btn-primary btn-link" ng-click="doBook()" value="Book" /></th>
      	</tr>
      	      	<tr>
      		...
      		<th><input type="button" name="room_link6" class="btn btn-primary btn-link" ng-click="doBook()" value="Book" /></th>
      		...
      		<th><input type="button" name="room_link7" class="btn btn-primary btn-link" ng-click="doBook()" value="Book" /></th>
