     ...
     <form method="post" ng-submit="showBook()">
      ...
      <table border = "1px" align="center">
      	<tr>
      		...
      		<th><input type="button" name="room_link3" class="btn btn-primary btn-link" ng-click="doBook()" value="Book" /></th>
      	</tr>
      	      	<tr>
      		...
      		<th><input type="button" name="room_link4" class="btn btn-primary btn-link" ng-click="doBook()" value="Book" /></th>
      	</tr>
      	</table>
      </div>
